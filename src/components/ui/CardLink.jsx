...
export const CardLink = ({ href, children, ariaLabel }) => {
  return (
    <a
      className="inline-flex items-baseline font-medium text-gray-100 transition-colors hover:text-purple-300 focus-visible:text-purple-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 group/link text-lg leading-tight"
      href={href}
      target="_blank"
